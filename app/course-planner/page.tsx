      ...
      <div className="container-app px-6 py-12 md:py-16 max-w-4xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm md:text-base max-w-lg mx-auto" style={{ color: "#64748B" }}>
            Fill in your profile below. Claude AI will search the web for real local opportunities and generate a personalized roadmap just for you.
          </p>
          {userId && (
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button type="submit" disabled={!isFormValid() || formState.step === "loading"} className="btn-primary w-full text-base py-4">
            {formState.step === "loading" ? (
              <>
                ...
                Claude is searching the web and building your plan…
              </>
            ) : (
              <>
          ...
          <p className="text-center text-xs mt-3" style={{ color: "#334155" }}>
            Fields marked * are required · Claude will search the web for real local opportunities
          </p>
        </form>
        ...
        {formState.step === "loading" && (
          <div className="mt-8 rounded-2xl p-6 md:p-8" style={{ background: "#111F3C", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-sm font-semibold" style={{ color: "#F0F4FF" }}>Searching the web + building {student.name ? `${student.name}'s` : "your"} plan…</p>
                <p className="text-xs" style={{ color: "#475569" }}>Claude is finding real local opportunities — this may take 20–40 seconds</p>
              </div>
            </div>
            <LoadingSkeleton />
          </div>
            ...
            <div className="px-6 md:px-8 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: "#475569" }}>Generated by Claude AI · {new Date().toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}</p>
                </div>
              </div>
